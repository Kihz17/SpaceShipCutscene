...
public:
	...
	static void RenderSubmeshWithColorOverride(Ref<Shader> shader, const Submesh& submesh, const glm::mat4& transform, const glm::vec3& colorOverride, bool debugMode = false, bool ignoreLight = false);
	static void RenderSubmesh(Ref<Shader> shader, const Submesh& submesh, const glm::mat4& transform, Ref<SubmeshData> submeshData, bool debugMode = false);
